...
assert.match(
  ...
  'Bij een lege schoolmail moet de cursor vóór @koraaledu.nl komen te staan'
);
...
assert.match(preload, /<script src=\\"\$\{SCRIPT_URL\}\\"><\/script>/, 'De helper moet daadwerkelijk in HTML worden geladen');
