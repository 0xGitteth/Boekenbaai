...
assert.deepStrictEqual(deriveThemesFromTags(['panic disorder']).themes, ['Psychische gezondheid']);
assert.deepStrictEqual(deriveThemesFromTags(['panic attack']).themes, ['Psychische gezondheid']);
assert.deepStrictEqual(deriveThemesFromTags(['panic attacks']).themes, ['Psychische gezondheid']);
assert.deepStrictEqual(deriveThemesFromTags(['panics']).themes, ['Psychische gezondheid']);
assert.deepStrictEqual(deriveThemesFromTags(['hispanic']).themes, []);
assert.deepStrictEqual(deriveThemesFromTags(['hispanic americans']).themes, []);
assert.deepStrictEqual(deriveThemesFromTags(['hispanic']).unmappedTags, ['hispanic']);
assert.deepStrictEqual(deriveThemesFromTags(['cult']).themes, ['Maatschappij']);
assert.deepStrictEqual(deriveThemesFromTags(['cults']).themes, ['Maatschappij']);
assert.deepStrictEqual(deriveThemesFromTags(['sect']).themes, ['Maatschappij']);
assert.deepStrictEqual(deriveThemesFromTags(['sects']).themes, ['Maatschappij']);
assert.deepStrictEqual(deriveThemesFromTags(['ocean']).themes, ['Natuur']);
assert.deepStrictEqual(deriveThemesFromTags(['sea']).themes, []);
assert.deepStrictEqual(deriveThemesFromTags(['north sea']).themes, []);
assert.deepStrictEqual(deriveThemesFromTags(['seas']).themes, []);
assert.deepStrictEqual(deriveThemesFromTags(['culture']).themes, []);
assert.deepStrictEqual(deriveThemesFromTags(['influence culture']).themes, ['Media & Invloed']);
assert.deepStrictEqual(deriveThemesFromTags(['sectie']).themes, []);
assert.deepStrictEqual(deriveThemesFromTags(['search']).themes, []);
